...
create_container() {
  ...
  do
    ...
    if [ $i -eq 1 ]; then
      docker run -itd -p 19090:9090 15005:5005 -p 15006:5006 -p 18080:8080 --name ${container_name} --hostname ${container_name} --network bigtop-manager --cap-add=SYS_TIME bigtop-manager/develop:${OS}
